...
class ViewController: UIViewController {
    ...
    var playMotionManager: CMMotionManager!
    ...
    override func viewDidLoad() {
        ...
        playMotionManager = CMMotionManager()
        playMotionManager.accelerometerUpdateInterval = 0.02
    ...
    func startAccelerometer() {
        ...
        let handler: CMAccelerometerHandler = {(CMAccelerometerData: CMAccelerometerData?, error: Error?) ->Void in
            ...
            var posY = self.playerView.center.y - (CGFloat(self.speedX) / 3)
        ...
        playMotionManager.startAccelerometerUpdates(to: OperationQueue.main, withHandler: handler)
    }
    
    func gameCheck(result: String, message: String){
        if playMotionManager.isAccelerometerActive{
            playMotionManager.stopAccelerometerUpdates()
        }
